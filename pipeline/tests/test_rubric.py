...
from clipforge_pipeline.candidates import curve as curve_mod
from clipforge_pipeline.candidates import windows as windows_mod
from clipforge_pipeline.music.brief import mood_prior
