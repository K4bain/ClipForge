...
from clipforge_pipeline.captions import ass as ass_mod
from clipforge_pipeline.render import ffmpeg_bin, renderer
...
def test_render_smoke(tmp_path):
    ...
    # ffmpeg is the fetched static one, reachable via CLIPFORGE_FFMPEG.
    subprocess.run(
        [
