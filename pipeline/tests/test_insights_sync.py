...
from clipforge_pipeline import config
from clipforge_pipeline.insights import calibration, instagram
from clipforge_pipeline.scoring import constants as constants_mod
from clipforge_pipeline.scoring import rubric


@pytest.fixture(autouse=True)
def isolated_home(tmp_path, monkeypatch):
    monkeypatch.setenv("CLIPFORGE_HOME", str(tmp_path / "home"))
    yield
