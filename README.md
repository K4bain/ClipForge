...
ClipForge is an open-source (AGPL-3.0) desktop app that takes a YouTube URL or a
horizontal video file and forges vertical 9:16 clips with:
...
Builds are currently unsigned — install from source below.
