        ...
        <header className="rail-brand">
          <div className="rail-brand-row">
            <span className="rail-mark" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="#1a0d05" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M14 2 L4 8 L4 16 L12 21 L20 16 L20 8 Z" fill="#1a0d05" />
                <path d="M4 8 L12 13 L20 8 M12 13 L12 21" />
              </svg>
            </span>
            <span className="rail-logo">ClipForge</span>
          </div>
          <span className="rail-sub">forge clips that earn their score</span>
        </header>
